...
"""main_reproduce.py: Reproduces CA-CAE results for cancer type inputted in command line."""
__author__ = "Amrita Kohli, Riya Bharamaraddi, & Tamara Hadzic"
...
if __name__ == "__main__":
    ...
    argparser.add_argument("--indir",
                           help="Input directory where to find BED files",
                           type=Path, required=True)
    argparser.add_argument("--infmt",
                           help="String describing BED filename format",
                           type=str, required=True)
    argparser.add_argument("--outfile",
                           help="Output file for the enhancer-gene table",
                           type=Path, required=True)
    argparser.add_argument("--origbed",
                           help="Original BED file of positions for all genes",
                           type=Path, required=True)
